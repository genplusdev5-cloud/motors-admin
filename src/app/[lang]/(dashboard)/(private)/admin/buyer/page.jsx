...
const Buyer = () => {
  ...
  <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
    <span style={{ fontSize: 16, fontWeight: 500, color: theme.palette.text.primary }}>Buyer</span>
  ...
  >
    ...
    {' / '}
    <Link href='/buyer' style={{ textDecoration: 'none', color: theme.palette.text.primary }}>
      Buyer
    </Link>
    {' / '}
    <Link href='/add-buyer' style={{ textDecoration: 'none', color: theme.palette.text.primary }}>
      Add Buyer
    </Link>
  </div>
</div>
