      ...
      <Card sx={{ p: '1.5rem' }}>
        ...
        <div style={{ marginBottom: 10, paddingBottom: 10, borderBottom: `1px solid ${theme.palette.divider}` }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
            <span style={{ fontSize: 16, fontWeight: 500, color: theme.palette.text.primary }}>Plans</span>
          ...
          >
            ...
            {' / '}
            <Link href='/plans' style={{ textDecoration: 'none', color: theme.palette.text.primary }}>
              Plans
            </Link>
            {' / '}
            <Link href='/add-plans' style={{ textDecoration: 'none', color: theme.palette.text.primary }}>
              Add Plans
            </Link>
          </div>
        </div>
