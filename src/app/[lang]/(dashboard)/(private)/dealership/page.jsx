      ...
      <Card sx={{ p: '1.5rem' }}>
        ...
        <div style={{ marginBottom: 10, paddingBottom: 10, borderBottom: `1px solid ${theme.palette.divider}` }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
            <span style={{ fontSize: 16, fontWeight: 500, color: theme.palette.text.primary }}>Dealership </span>
    ...
    >
      Add
          ...
          >
            ...
            {' / '}
            <Link href='/dealership' style={{ textDecoration: 'none',  color: theme.palette.text.primary  }}>
              Dealership
            </Link>
            {' / '}
            <Link href='/add-dealership' style={{ textDecoration: 'none', color: theme.palette.text.primary  }}>
             Add Dealership
            </Link>
          </div>
        </div>
