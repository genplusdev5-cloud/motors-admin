  ...
  const columns = [
    ...
    columnHelper.accessor('is_active', {
      ...
      cell: info => {
        ...
        const bgColor =
          statusValue === 'Active'
            ? theme.palette.success.main // Use main color for solid badge background
            : theme.palette.error.main

        const textColor = theme.palette.common.white // White text for color contrast
      ...
      <Card sx={{ p: '1.5rem' }}>
        ...
        <div style={{ marginBottom: 10, paddingBottom: 10, borderBottom: `1px solid ${theme.palette.divider}` }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
            <span style={{ fontSize: 16, fontWeight: 500, color: theme.palette.text.primary }}>Features</span>
            <Button
