...
export const getCylinder = async () => {
  ...
  const res = await axiosInstance.get('/cylinder-list/')
...
export const addCylinder = async payload => {
  const res = await axiosInstance.post('/cylinder-add/', payload)
...
export const updateCylinder = async (id, payload) => {
  const res = await axiosInstance.put(`/cylinder-update/${id}/`, payload)
...
export const deleteCylinder= async id => {
  try {
    ...
    const res = await axiosInstance.delete(`/cylinder-delete/${id}/`);
