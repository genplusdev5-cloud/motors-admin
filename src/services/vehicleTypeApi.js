...
export const getVehicle = async () => {
  ...
  const res = await axiosInstance.get('/vehicle-type-list/')
...
export const addVehicle = async payload => {
  const res = await axiosInstance.post('/vehicle-type-add/', payload)
...
export const updateVehicle = async (id, payload) => {
  const res = await axiosInstance.put(`/vehicle-type-update/${id}/`, payload)
...
export const deleteVehicle = async id => {
  ...
  const res = await axiosInstance.delete(`/vehicle-type-delete/${id}/`)
